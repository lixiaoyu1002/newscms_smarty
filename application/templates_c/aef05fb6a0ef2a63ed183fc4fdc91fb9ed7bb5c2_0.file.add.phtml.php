<?php
/* Smarty version 3.1.29, created on 2016-06-25 01:55:57
  from "/home/ftp/201404lixiaoyu/newscms_smartyt/application/views/roles/add.phtml" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_576d742db9c1e1_12600507',
  'file_dependency' => 
  array (
    'aef05fb6a0ef2a63ed183fc4fdc91fb9ed7bb5c2' => 
    array (
      0 => '/home/ftp/201404lixiaoyu/newscms_smartyt/application/views/roles/add.phtml',
      1 => 1466790514,
      2 => 'file',
    ),
  ),
...
function content_576d742db9c1e1_12600507 ($_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
...
roles/index">角色管理</a><span class="crumb-step">&gt;</span><span>添加角色</span></div>
        </div>
        <div class="result-wrap">
            <form action="<?php echo PUBLIC_PATH;?>
roles/add" method="post" id="myform" name="myform" enctype="multipart/form-data">
               <table class="insert-tab" width="100%">
                    <tbody>
                        <tr>
                            <th><i class="require-red">*</i>角色名：</th>
                            <td>
                                <input type="text" name="name"  class="common-text" size="80" />
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>密码：</th>
                            <td>
                                <input type="password" class="common-textarea" name="pwd" /> 
                            </td>
                        </tr>
                        <tr>
