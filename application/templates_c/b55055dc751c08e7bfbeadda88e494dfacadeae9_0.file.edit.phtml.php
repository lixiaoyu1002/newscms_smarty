<?php
/* Smarty version 3.1.29, created on 2016-12-05 18:42:19
  from "/home/ftp/201404lixiaoyu/newscms_smartyt/application/views/types/edit.phtml" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5845448bdc9a59_61379924',
  'file_dependency' => 
  array (
    'b55055dc751c08e7bfbeadda88e494dfacadeae9' => 
    array (
      0 => '/home/ftp/201404lixiaoyu/newscms_smartyt/application/views/types/edit.phtml',
      1 => 1466790514,
      2 => 'file',
    ),
  ),
...
function content_5845448bdc9a59_61379924 ($_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
...
type/index">分类管理</a><span class="crumb-step">&gt;</span><span>编辑分类</span></div>
        </div>
        <div class="result-wrap">
            <form action="<?php echo PUBLIC_PATH;?>
type/edit" method="post" id="myform" name="myform" enctype="multipart/form-data">
               <table class="insert-tab" width="100%">
                    <tbody>
                        <tr>
                            <th width="120"><i class="require-red">*</i>类别名称：</th>
                            <td>
                            	<input class="common-text" size="80" type="text" name="name" value="<?php echo $_smarty_tpl->tpl_vars['types']->value['name'];?>
 ">
                            	<input hidden="hidden" size="80" type="text" name="id" value="<?php echo $_smarty_tpl->tpl_vars['types']->value['id'];?>
 ">
                            </td>
                        ...
                        <tr>
                                ...
                                <td>
                                   <textarea class="common-textarea" id="content" name="description" cols="30" style="width: 98%;" rows="10"><?php echo $_smarty_tpl->tpl_vars['types']->value['description'];?>
</textarea>
                                </td>
                            </tr>
                            <tr>
