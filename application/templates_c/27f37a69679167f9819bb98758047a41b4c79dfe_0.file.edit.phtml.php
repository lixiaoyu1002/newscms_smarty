<?php
/* Smarty version 3.1.29, created on 2016-06-24 13:49:59
  from "G:\wamp\www\newscms_smarty\application\views\users\edit.phtml" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_576d1e67e74f40_33752984',
  'file_dependency' => 
  array (
    '27f37a69679167f9819bb98758047a41b4c79dfe' => 
    array (
      0 => 'G:\\wamp\\www\\newscms_smarty\\application\\views\\users\\edit.phtml',
      1 => 1466766736,
      2 => 'file',
...
function content_576d1e67e74f40_33752984 ($_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
...
users/index">管理员管理</a><span class="crumb-step">&gt;</span><span>编辑管理员</span></div>
        </div>
        <div class="result-wrap">
            <form action="<?php echo PUBLIC_PATH;?>
users/edit" method="post" id="myform" name="myform" enctype="multipart/form-data">
               <table class="insert-tab" width="100%">
                    <tbody>
						<tr>
                            <th><i class="require-red">*</i>用户名：</th>
                            <td>
                                <input type="text" name="username"  class="common-text" size="80" / value="<?php echo $_smarty_tpl->tpl_vars['users']->value['username'];?>
">
                            </td>
                        </tr>
                        <tr hidden="hidden">
                            ...
                            <td>
                                <textarea class="common-textarea" name="password" cols="30" style="width: 98%;" rows="5"><?php echo $_smarty_tpl->tpl_vars['users']->value['password'];?>
</textarea>
                            </td>
                        </tr>
                           <tr>
                            ...
                            <td>
                                <textarea class="common-textarea" name="email" cols="30" style="width: 98%;" rows="5"><?php echo $_smarty_tpl->tpl_vars['users']->value['email'];?>
</textarea>
                            </td>
                        </tr>
                           <tr>
                            ...
                            <td>
                                <textarea class="common-textarea" name="question" cols="30" style="width: 98%;" rows="5"><?php echo $_smarty_tpl->tpl_vars['users']->value['question'];?>
</textarea>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <textarea class="common-textarea" name="answer" cols="30" style="width: 98%;" rows="15"><?php echo $_smarty_tpl->tpl_vars['users']->value['answer'];?>
</textarea>
                            </td>
                        </tr>
                        <tr>
