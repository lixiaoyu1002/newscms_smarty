<?php
/* Smarty version 3.1.29, created on 2016-06-25 01:53:28
  from "/home/ftp/201404lixiaoyu/newscms_smartyt/application/views/comments/edit.phtml" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_576d7398087781_43512240',
  'file_dependency' => 
  array (
    '71362251c3074251e75d94e176ca50a074ef16c0' => 
    array (
      0 => '/home/ftp/201404lixiaoyu/newscms_smartyt/application/views/comments/edit.phtml',
      1 => 1466790512,
      2 => 'file',
    ),
  ),
...
function content_576d7398087781_43512240 ($_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
...
comments/index">评论管理</a><span class="crumb-step">&gt;</span><span>编辑评论</span></div>
        </div>
        <div class="result-wrap">
            <form action="<?php echo PUBLIC_PATH;?>
comments/edit" method="post" id="myform" name="myform" enctype="multipart/form-data">
               <table class="insert-tab" width="100%">
                    <tbody>
						 <tr>
                            <th><i class="require-red">*</i>标题：</th>
                            <td>
                            	<input type="text" hidden="hidden" name="id"value="<?php echo $_smarty_tpl->tpl_vars['Msg']->value['id'];?>
"/>
                                <input type="text" name="title"  class="common-text" size="80" value="<?php echo $_smarty_tpl->tpl_vars['Msg']->value['title'];?>
"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="author"  class="common-text" size="80" value="<?php echo $_smarty_tpl->tpl_vars['Msg']->value['author'];?>
"/>
                            </td>
                        </tr>
                           <tr>
                            ...
                            <td>
                                ...
                                <input type="textarea" name="content"  class="common-text" size="80" value="<?php echo $_smarty_tpl->tpl_vars['Msg']->value['content'];?>
"/>
                            </td>
                        </tr>
                        <tr>
